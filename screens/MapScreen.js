...
export default function MapScreen() {
  ...
  useEffect(() => {
    ...
    fetch(`https://locapic-backend-blue-six.vercel.app/places/${user.nickname}`)
  ...
  const handleNewPlace = () => {
    // send place to backend to register in DB
    fetch('https://locapic-backend-blue-six.vercel.app/places', {
        method: 'POST',
    ...
    // changer en chaine de caracteres
    .then(response => response.json())
    .then(data => {
        if (data.result) {
          dispatch(addPlace({ 
